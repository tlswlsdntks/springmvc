...
public class RequestBodyJsonController {
    ...
    // localhost:8080/request-body-json-v1, {"username" : name, "age" : 30}
    ...
    // localhost:8080/request-body-json-v2, {"username" : name, "age" : 30}
    @ResponseBody
    ...
    // localhost:8080/request-body-json-v3, {"username" : name, "age" : 30}
    @ResponseBody
    ...
    // localhost:8080/request-body-json-v4, {"username" : name, "age" : 30}
    @ResponseBody
